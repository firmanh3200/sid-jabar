...
st.title("Ketersediaan Bidan di Desa")
...
if tahunterpilih:
    ...
    def fetch_data(page, limit=25):
        url = f"https://portaldatadesa.jabarprov.go.id/api/idm/idmdataidentitas/v2?sub_name=Ketersediaan%20Tenaga%20Kesehatan%20Bidan&tahun={tahunterpilih}&order=asc&orderby=id_desa&page={page}&limit={limit}"
