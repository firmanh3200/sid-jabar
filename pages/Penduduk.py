...
if tahunterpilih:
    ...
    def fetch_data(page, limit=25):
        url = f"https://portaldatadesa.jabarprov.go.id/api/idm/idmdataidentitas/v2?sub_name=Penduduk&tahun={tahunterpilih}&order=asc&orderby=id_desa&page={page}&limit={limit}"
