...
st.title("Keluarga Berisiko dan Rentan Stunting")
...
if tahunterpilih:
    ...
    def fetch_data(page, limit=25):
        url = f"https://portaldatadesa.jabarprov.go.id/api/idm/idmdataidentitas/v2?sub_name=Keluarga%20Berisiko%20Stunting%20dan%20Rentan&tahun={tahunterpilih}&order=asc&orderby=id_desa&page={page}&limit={limit}"
